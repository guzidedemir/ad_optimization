...
class HierarchicalLDA(object):
    ...
    def estimate(self, num_samples, display_topics=50, n_words=5, with_weights=True, txt=None):
        ...
        for s in range(num_samples):
            ...
            if (s > 0) and ((s+1) % display_topics == 0):
                ...
                # if txt is not None:
                #   txt.write(" %d\n" % (s+1))
                self.print_nodes(n_words, with_weights, txt=txt)
    ...
    def print_nodes(self, n_words, with_weights, txt=None):
        self.print_node(self.root_node, 0, n_words, with_weights, txt=txt)

    def print_node(self, node, indent, n_words, with_weights, txt=None):
        out = '    ' * indent
        ...
        if txt is not None:
            txt.write(out + "\n")
        for child in node.children:
            self.print_node(child, indent+1, n_words, with_weights, txt=txt)
